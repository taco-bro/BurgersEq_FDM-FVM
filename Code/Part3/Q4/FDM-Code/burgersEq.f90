MODULE common_data
    save
    integer, parameter          :: inputRe = 400
    integer, parameter          :: N = 1600
    real*8, parameter           :: Len=1.d0, u0=1.d0, nu=1.d0/real(inputRe), CFL=0.325d0, t_tilde=7.0d0
...
PROGRAM MAIN
    ...
    !                            file operation
    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    write(fileName, '("uSolutionRe", I5.5, "N", I5.5, ".dat")') int(Re), N
    open(55, file=fileName, status='replace', action='write')
